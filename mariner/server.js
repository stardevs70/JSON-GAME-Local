...
app.use(
  "/images",
  express.static(
    path.join(__dirname, "static/games/slots/mariner/style/images")
  )
);
...
// Symbol 10 = scatter (joker in free spins) - excluded from line wins
const WIN_TABLE = {
  2: { 2: 5, 3: 50, 4: 200, 5: 1000 },
  3: { 2: 5, 3: 25, 4: 100, 5: 500 },
  4: { 2: 5, 3: 15, 4: 75, 5: 250 },
  5: { 3: 10, 4: 40, 5: 150 },
  6: { 3: 10, 4: 40, 5: 150 },
  7: { 3: 10, 4: 40, 5: 150 },
  8: { 3: 5, 4: 20, 5: 100 },
...
const SCATTER_SYMBOL = 10; // scatter (also joker in free spins)
const SPECIAL_SYMBOLS = [1, 10]; // joker + scatter: max 1 per column
...
app.listen(PORT, () => {
  console.log(`\n  Mariner running at http://localhost:${PORT}\n`);
