...
app.use(
  "/images",
  express.static(
    path.join(__dirname, "static/games/slots/hearts/style/images")
  )
);
...
// Symbol 1 = joker (wild), Symbol 11 = scatter - both excluded from line wins
const WIN_TABLE = {
  2: { 2: 5, 3: 50, 4: 300, 5: 3000 },
  3: { 2: 2, 3: 25, 4: 100, 5: 500 },
  4: { 3: 20, 4: 75, 5: 500 },
  5: { 3: 20, 4: 75, 5: 500 },
  6: { 3: 10, 4: 50, 5: 250 },
  7: { 3: 10, 4: 50, 5: 200 },
...
const SCATTER_SYMBOL = 11; // scatter
const SPECIAL_SYMBOLS = [1, 11]; // joker and scatter: max 1 per column
...
app.listen(PORT, () => {
  console.log(`\n  Hearts running at http://localhost:${PORT}\n`);
