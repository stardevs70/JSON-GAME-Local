...
app.use(
  "/images",
  express.static(
    path.join(__dirname, "static/games/slots/hot-slot/style/images")
  )
);
...
const SPECIAL_SYMBOLS = [1, 8]; // seven and x: max 1 per column
...
app.listen(PORT, () => {
  console.log(`\n  Hot Slot running at http://localhost:${PORT}\n`);
