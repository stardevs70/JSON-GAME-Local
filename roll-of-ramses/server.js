...
app.use(
  "/images",
  express.static(
    path.join(__dirname, "static/games/slots/roll-of-ramses/style/images")
  )
);
...
// Symbol 10 = scatter+joker (scroll) - excluded from line wins
const WIN_TABLE = {
...
const SCATTER_SYMBOL = 10; // scroll (also joker)
const SPECIAL_SYMBOLS = [10]; // scroll: max 1 per column
...
app.listen(PORT, () => {
  console.log(`\n  Roll of Ramses running at http://localhost:${PORT}\n`);
