...
app.use(
  "/images",
  express.static(
    path.join(__dirname, "static/games/slots/king-of-jewels/style/images")
  )
);
...
// Symbol 8 = scatter - excluded from line wins
// No joker/wild symbol in this game
const WIN_TABLE = {
  1: { 3: 50, 4: 500, 5: 5000 },
  2: { 3: 30, 4: 150, 5: 500 },
  3: { 3: 30, 4: 150, 5: 500 },
...
app.listen(PORT, () => {
  console.log(`\n  King of Jewels running at http://localhost:${PORT}\n`);
