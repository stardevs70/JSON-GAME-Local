...
app.use(
  "/images",
  express.static(
    path.join(__dirname, "static/games/slots/sevens-on-fire/style/images")
  )
);
...
// Symbol 8 = scatter - excluded from line wins. No joker/wild in this game.
const WIN_TABLE = {
  1: { 3: 100, 4: 1000, 5: 5000 },
  2: { 3: 50, 4: 200, 5: 500 },
  3: { 3: 50, 4: 200, 5: 500 },
  4: { 3: 20, 4: 50, 5: 200 },
  5: { 3: 20, 4: 50, 5: 200 },
  6: { 3: 20, 4: 50, 5: 200 },
  7: { 2: 5, 3: 20, 4: 50, 5: 200 },
};

const SCATTER_SYMBOL = 8; // scatter
const SPECIAL_SYMBOLS = [8]; // scatter: max 1 per column
...
app.listen(PORT, () => {
  console.log(`\n  Sevens on Fire running at http://localhost:${PORT}\n`);
