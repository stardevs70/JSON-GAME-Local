...
app.use(
  "/images",
  express.static(
    path.join(__dirname, "static/games/slots/lucky-lady-glamour/style/images")
  )
);
...
// Symbol 1 = joker (wild), Symbol 13 = scatter - both excluded from line wins
const WIN_TABLE = {
  2: { 2: 2, 3: 25, 4: 125, 5: 750 },
  3: { 2: 2, 3: 25, 4: 125, 5: 750 },
  4: { 3: 20, 4: 100, 5: 400 },
  5: { 3: 15, 4: 75, 5: 250 },
  6: { 3: 15, 4: 75, 5: 250 },
  7: { 3: 10, 4: 50, 5: 125 },
  ...
  10: { 3: 5, 4: 25, 5: 100 },
  11: { 3: 5, 4: 25, 5: 100 },
  12: { 2: 2, 3: 5, 4: 25, 5: 100 },
};

const SCATTER_SYMBOL = 13; // scatter
const SPECIAL_SYMBOLS = [1, 13]; // joker and scatter: max 1 per column
...
function generateSpinResponse(params) {
  ...
  for (let lineIdx = 0; lineIdx < lines && lineIdx < PAYLINES.length; lineIdx++) {
    ...
    // Skip scatter and joker symbols - they don't start line wins
    if (firstSym === SCATTER_SYMBOL || firstSym === 1) continue;
...
app.listen(PORT, () => {
  console.log(`\n  Lucky Lady Glamour running at http://localhost:${PORT}\n`);
