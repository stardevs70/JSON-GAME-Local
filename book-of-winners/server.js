...
app.use(
  "/images",
  express.static(
    path.join(__dirname, "static/games/slots/book-of-winners/style/images")
  )
);
...
// Symbol 10 = scatter+joker (book) - excluded from line wins
const WIN_TABLE = {
  1: { 2: 10, 3: 100, 4: 1000, 5: 5000 },
  2: { 2: 5, 3: 40, 4: 400, 5: 2000 },
  3: { 2: 5, 3: 30, 4: 100, 5: 750 },
  4: { 2: 5, 3: 30, 4: 100, 5: 750 },
  5: { 3: 5, 4: 40, 5: 150 },
  6: { 3: 5, 4: 40, 5: 150 },
  7: { 3: 5, 4: 25, 5: 100 },
  8: { 3: 5, 4: 25, 5: 100 },
...
const SCATTER_SYMBOL = 10; // book (also joker)
const SPECIAL_SYMBOLS = [10]; // book: max 1 per column
...
app.listen(PORT, () => {
  console.log(`\n  Book of Winners running at http://localhost:${PORT}\n`);
